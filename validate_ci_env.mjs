// Script de validação da Cadência Individual com lógica de ratio
// Usa variáveis de ambiente injetadas pelo sistema

import mysql from 'mysql2/promise';

const {
  DB_EXT_HOST, DB_EXT_PORT, DB_EXT_USER, DB_EXT_PASS, DB_EXT_NAME,
  SSH_TUNNEL_HOST, SSH_TUNNEL_PORT, SSH_TUNNEL_USER, SSH_TUNNEL_PASS
} = process.env;

// Check if SSH tunnel is running on port 13307
let port = 13307;
let host = '127.0.0.1';
